...
def dTree(Data,node,count):
	...
	(splitData1, splitData2, attribute, value) = split(Data,20,'mean_squared's)
	count = count + 1
	node.name = count;
	if attribute != -1:
...
def main():
	data = pd.read_csv('/Users/deveshkumar/Downloads/ml_assing/data/first/train.csv')
	#print(data)
	test = pd.read_csv('/Users/deveshkumar/Downloads/ml_assing/data/first/treestr.csv')
